...
const QString BITCOIN_IPC_PREFIX("starcoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click starcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start starcoin: click-to-pay handler");
    else
...
{
    // clicking on starcoin: URLs creates FileOpen events on the Mac:
