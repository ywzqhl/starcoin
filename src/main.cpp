...
// Copyright (c) 2013 The starcoin developers
...
uint256 hashGenesisBlock("0x0000089818ce94d7809c78c54316ebc19ccd86d2db7f486423fc5df5ee4e1fff");
static const unsigned int timeGenesisBlock = 1456049603;
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "already in already CBigNum we starcoin from USA with Transactions.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x1585f653ee0902bf1a4859347f534886c29e14536b4656cc475138a418dc9cb5"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("starcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("starcoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("starcoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("starcoin-miner");
    ...
    try { loop {
        ...
        printf("Running starcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("starcoinMiner terminated\n");
        throw;
    }
}
